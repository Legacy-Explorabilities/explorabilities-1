...
routes.post('/iatacodes/', function(req, res) {
  ...
  request('https://iatacodes.org/api/v6/nearby?api_key=23116fc6-26dc-471e-a90c-537e7511569a&lat=' + req.body.lat + '&lng=' + req.body.lng + '&distance=50', function (error, response, body) {
